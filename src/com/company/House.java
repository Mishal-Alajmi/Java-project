...
* 03/17/2017
*
 * The House class is derived from the Location class, it does not require any further fields so it will use the ones
...
class House extends Location {
    ...
    public void inputInfo() {
        ...
        this.residenceType = new String("House");
        ...
        System.out.println("On what street is the House located: ");
        this.addressName = input.nextLine();

        System.out.println("How many rooms does your home have: ");
        this.roomCount = input.nextInt();

        System.out.println("How many guests are allowed to rent the home: ");
